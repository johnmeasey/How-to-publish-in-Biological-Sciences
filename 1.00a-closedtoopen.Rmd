...
## Peer review
Few would argue that peer review is at the heart of publishing in science today. Consequently, there are several chapters in this book concerned with the subject: [What is peer review](peerreview.html); [what to expect from your peer reviewers](peerreview2.html); [how to respond to peer review with a rebuttal](rebuttal.html); [and how to conduct peer review](howpeerreview.html). The last chapter covers [problems with peer review](problempeerreview.html) and this digs into some of the real biases that occur during peer review, and with the reviewers themselves. Peer review isn't a perfect system, but we need to understand the weaknesses, both as authors and as reviewers. Only through this understanding we reinvent the publishing system. We should not expect to do away with peer review (although this has been suggested many times in the past, and no doubt will be suggested again in the future), but by understanding the limitations we will be able to make sensible account of the biases that exist.
...
## Impact factor
[Impact factor](impactfactor.html) is a simple metric, and as such there is no need for it to be anything more. But the publishers have managed to use impact factor to their advantage such that it has become of overriding importance for many publishing in science today. But it doesn't have to be this way, and through understanding of the way in which impact factor can [control other aspects of publishing](#money). The behaviour of the [editor can have a profound effect on the impact factor](#increaseIF). The higher Impact Factor results in more submissions, and this in turn will mean that the editor will have more power over the content of their journal.

## Citations {#cite}
Sitting above Peer review and Impact Factor in Figure \@ref(fig:publishing-triangle) are [citations](citations.html). Compared to the other two parts of this problematic system, citations seem to be blameless and without the potential biases of the others. However, citations are the units of control for Impact Factor and can be manipulated by both editors and peer reviewers. [Metrics](citations.html) driven by citations are also at the heart of many of the problems in todays publishing world. 
