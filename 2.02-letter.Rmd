...
Chief editors may read parts of the cover letter along with the abstract before deciding which Associate Editor should be assigned. Some chief editors will even leave this to the Associate Editor. The Associate Editor should read your cover letter in full, together with the metadata and other salient information therein. They should also [read the entire manuscript](#editors).  It is worth noting that reviewers are not given access to cover letters.
