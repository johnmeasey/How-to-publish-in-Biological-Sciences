...
- Reviews should be conducted within a reasonable time frame. No reviewer should hold on to a manuscript especially if they have a vested interest (like a rival study) in not seeing it published. This should have been declared as [conflict of interest](#conflicts)
- Any other potential [conflicts of interest](#conflicts), especially those that might make you positively predisposed to the authors, should be declared
