...
Measey, J. (`r format(Sys.time(), '%Y')`) _How to publish in Biological Sciences: a guide for the uninitiated_. Available from: https://howtopublishscience.org/ Accessed on: `r format(Sys.time(), '%d %B %Y')`.
