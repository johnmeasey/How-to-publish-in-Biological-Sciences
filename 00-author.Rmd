...
Measey, J. (`r format(Sys.time(), '%Y')`) _How to publish in Biological Sciences: a guide for the uninitiated_. Available from: https://howtopublishscience.org/ Updated on: `r format(Sys.time(), '%d %B %Y')`.
...
```{r fig.align='centre', out.width = '66%', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), fig.link='https://creativecommons.org/licenses/by-nc-nd/4.0/'}
knitr::include_graphics('figures/BY-NC-ND.png', dpi = NA)
```
