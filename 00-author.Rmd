...
John Measey is Associate Professor of Biological Sciences at Stellenbosch University. He has authored or co-authored more than 200 [peer reviewed scientific papers](http://john.measey.com/Publications/Journal-Articles) and [book chapters](http://john.measey.com/Publications/Book-Chapters), and [five books](http://john.measey.com/Publications/Books). This includes [How to write a PhD in Biological Sciences: a guide for the uninitiated](http://www.howtowriteaphd.org/), also published by CRC Press. He was the Editor-in-Chief of an ISI journal for 9 years, and currently serves as Associate Editor for 4 other journals. He has graduated more than 20 postgraduate students, and his [blog](http://john.measey.com/Blog) on writing and publishing in biological sciences is read by thousands globally. British born and educated, he lives and works in the beautiful Western Cape, South Africa.
...
```{r iris}
knitr::kable(
  head(iris), caption = 'We still have the iris data and some R code',
  booktabs = TRUE
)
```
