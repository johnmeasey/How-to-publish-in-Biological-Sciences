...
Given that you are reading this book, I will assume that you plan to publish your work. However, there are still some basics that I think it is worth considering in this first part of the book:
 ...
 - [What is a journal for?](whatjournalfor.html)
 - [What is it possible to publish?](whattowrite.html)
 - [What is peer review](peerreview.html)
 - [What is the journal Impact Factor?](impactfactor.html)
 - [Why are citations important?](citations.html)
